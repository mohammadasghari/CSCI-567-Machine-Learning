...
def main(main_params):
    ...
    for t in range(num_epoch):
        ...
        for i in range(int(np.floor(N_train / minibatch_size))):
            ...
            # TODO (2)
            x_2nd_L = m1
            a2_2nd_L = model['C2'].forward(x_2nd_L)
            h2_2nd_L = model['nonlinear2'].forward(a2_2nd_L)
            m2_2nd_L = model['M2'].forward(h2_2nd_L)
            m2 = m2_2nd_L
            ...
            grad_h2_2nd_L = model['M2'].backward(h2_2nd_L, grad_m2)
            grad_a2_2nd_L = model['nonlinear2'].backward(a2_2nd_L, grad_h2_2nd_L)
            grad_x_2nd_L = model['C2'].backward(x_2nd_L, grad_a2_2nd_L)
            grad_m1 = grad_x_2nd_L
